#ifndef _PMQ_CONDUCTOR_HEARTBEATS_COLLECTOR_HPP_INCLUDED_
#define _PMQ_CONDUCTOR_HEARTBEATS_COLLECTOR_HPP_INCLUDED_
...
class conductor_heartbeats_collector : public heartbeats_collector, private boost::noncopyable {
public:
	conductor_heartbeats_collector(const std::string& mip, unsigned short mport);
	virtual ~conductor_heartbeats_collector();
...
#endif // _PMQ_CONDUCTOR_HEARTBEATS_COLLECTOR_HPP_INCLUDED_