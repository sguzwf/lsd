...
public:	
	...
	service_info (const std::string& name, const std::string& description, const std::string& app_name, const std::string& hosts_url) :
	name_(name), description_(description), app_name_(app_name), hosts_url_(hosts_url), control_port_(DEFAULT_CONTROL_PORT) {};
