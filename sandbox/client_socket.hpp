#ifndef _LSD_SERVER_SOCKET_HPP_INCLUDED_
#define _LSD_SERVER_SOCKET_HPP_INCLUDED_
...
class server_socket  {
public:
	server_socket(const service_inf& sinfo, const std::vector<host_info>& hosts, boost::shared_ptr<server_context> context);
...
#endif // _LSD_SERVER_SOCKET_HPP_INCLUDED_